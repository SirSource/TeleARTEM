angular.module('AppChat').controller('ChatController', ['$http', '$log', '$scope', '$location', '$routeParams', function($http, $log, $scope, $location, $routeParams) {
        ...
        this.newSearch = "";
         ...
         this.loadMessages = function(){
            ...
            var url = "http://chatapp.us-east-1.elasticbeanstalk.com/ChatApp/messagesAllChat/" + chatId;
        ...
        this.postMsg = function(){
            ...
            $http.get("http://chatapp.us-east-1.elasticbeanstalk.com/ChatApp/id").then(function (response) {
                    ...
                    var url = "http://chatapp.us-east-1.elasticbeanstalk.com/ChatApp/chats/"+$routeParams.cid+"/messages/post/"+userId+"/"+message;
                    $http.post(url);
                    });
